...
class Node:
    ...
    Contains pointer to parent and to the actual state for this node.
    Include the action that got us to this state and the total pathCost to reach the node.
    """
    ...
    def getCost(self):
        """Return total cost to reach current state."""
